...
pop[face2corner(U,L,F)][1]=0; pop[face2corner(U,F,L)][0]=1; pop[face2edge(U,F)][1]=0; pop[face2edge(U,F)][0]=1;
pop[face2corner(F,U,L)][1]=1; pop[face2corner(F,L,U)][0]=1; pop[face2edge(F,U)][1]=1; pop[face2edge(F,U)][0]=1;
pop[face2corner(L,F,U)][1]=2; pop[face2corner(L,U,F)][0]=1; pop[face2edge(U,R)][1]=0; pop[face2edge(U,R)][0]=2;

pop[face2corner(U,R,F)][1]=0; pop[face2corner(U,R,F)][0]=2; pop[face2edge(R,U)][1]=1; pop[face2edge(R,U)][0]=2;
pop[face2corner(F,U,R)][1]=1; pop[face2corner(R,F,U)][0]=2; pop[face2edge(U,B)][1]=0; pop[face2edge(U,B)][0]=3;
pop[face2corner(R,F,U)][1]=2; pop[face2corner(F,U,R)][0]=2; pop[face2edge(B,U)][1]=1; pop[face2edge(B,U)][0]=3;
...
pop[face2corner(U,R,B)][1]=0; pop[face2corner(U,B,R)][0]=4; pop[face2edge(F,L)][1]=1; pop[face2edge(F,L)][0]=5;
pop[face2corner(B,U,R)][1]=1; pop[face2corner(B,R,U)][0]=4; pop[face2edge(R,F)][1]=0; pop[face2edge(R,F)][0]=6;
pop[face2corner(R,B,U)][1]=2; pop[face2corner(R,U,B)][0]=4; pop[face2edge(F,R)][1]=1; pop[face2edge(F,R)][0]=6;
...
pop[face2corner(D,R,F)][1]=0; pop[face2corner(D,F,R)][0]=6; pop[face2edge(B,R)][1]=1; pop[face2edge(B,R)][0]=8;
pop[face2corner(F,D,R)][1]=1; pop[face2corner(F,R,D)][0]=6; pop[face2edge(D,F)][1]=0; pop[face2edge(D,F)][0]=9;
pop[face2corner(R,F,D)][1]=2; pop[face2corner(R,D,F)][0]=6; pop[face2edge(F,D)][1]=1; pop[face2edge(F,D)][0]=9;

pop[face2corner(D,L,B)][1]=0; pop[face2corner(D,B,L)][0]=7; pop[face2edge(D,R)][1]=0; pop[face2edge(D,R)][0]=10;
pop[face2corner(B,D,L)][1]=1; pop[face2corner(B,L,D)][0]=7; pop[face2edge(R,D)][1]=1; pop[face2edge(R,D)][0]=10;
pop[face2corner(L,B,D)][1]=2; pop[face2corner(L,D,B)][0]=7; pop[face2edge(D,B)][1]=0; pop[face2edge(D,B)][0]=11;
